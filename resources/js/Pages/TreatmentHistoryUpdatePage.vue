...
const submit = async () => {
    try{
        ...
        const response = await axios.put(`/api/treatment/update/primary/${patientId}`, form);
        ...
        await axios.post('/api/create-notification-log', {
            ...
            message: `The patient's PRIMARY treatment is updated`,
            senderId: userId,
        ...
        if (response.status === 200) {
            ...
            alert.value = {
                    show: true,
                    message: 'Success! Treatment history updated.',
                    type: 'success',
                };
